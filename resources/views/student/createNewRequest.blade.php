        ...
        <div class="mt-4 py-10 w-full rounded-xl shadow px-6 max-sm:px-3">
            ...
            <form method="POST" action="{{route('student.request')}}" class="grid grid-cols-2 max-md:grid-cols-1 gap-4">
                ...
                <div class="p-4 flex items-center gap-4">
                    ...
                    <input type="text" placeholder="Enter birthplace here" name="birthplace" id="birthplace" class="placeholder-slate-600 px-6  py-3 w-full rounded-md shadow bg-transparent border-none outline-none focus:ring-2 focus:ring-green-600">
                </div>

                <div class="p-4 flex items-center gap-4">
                    <label for="student_number" class="font-bold text-md">Student number:</label>
                    <input type="text" placeholder="Enter student number " name="student_number" id="student_number" class="placeholder-slate-600 px-6  py-3 w-full rounded-md shadow bg-transparent border-none outline-none focus:ring-2 focus:ring-green-600">
                </div>
