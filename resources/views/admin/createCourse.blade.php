...
@section('content')
    ...
    <section class="xl:max-w-[1300px] 2xl:max-w-[1500px] mx-auto p-4 w-full px-8 max-lg:px-4">
        ...
        <div class="w-full rounded-md shadow mt-8 py-6 px-4 md:px-8">
                ...
                <form action="{{route('admin.saveCourse')}}" method="POST" class="flex justify-center flex-col gap-8 pt-5 max-w-[800px] mx-auto ">
                    @csrf
                    <div class="py-4">
                        <h4 class="text-2xl font-bold text-center">CREATE COURSE:</h4>
                    </div>
