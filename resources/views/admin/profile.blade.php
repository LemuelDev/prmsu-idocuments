...
@section('content')
    ...
    <section class="xl:max-w-[1300px] 2xl:max-w-[1500px] mx-auto p-4 w-full px-8 max-lg:px-4">
        ...
        @if ($editing ?? false)
            ...
            <form method="POST" action="{{route('admin.updateProfile', auth()->user()->id)}}" class="w-full grid md:grid-cols-2 grid-cols-1 gap-4" >
                @csrf
                @method('PUT')
                ...
                <div class="p-4 flex items-center gap-4">
                 ...
                 <div class="p-4 flex items-center gap-4">
                    ...
                    <input type="number" name="phone_number" id="phone_number" value="{{auth()->user()->userProfile->phone_number}}" placeholder="Enter your phone number..." class="py-3 rounded-md w-full px-6 shadow  border-gray-400 border-2 outline-none">
                </div>
        ...
        <div class="mt-4 py-10  w-full rounded-xl shadow grid grid-cols-2 max-md:grid-cols-1 gap-4 px-6">
           ...
           <div class="p-4 flex items-center gap-4">
             ...
             <div class="p-4 flex items-center gap-4">
                <label for="birthday" class="font-bold">BIRTHDAY:</label>
                <input type="text" name="birthday"  class="py-3 px-6 w-full rounded-md  border-gray-400 border-2 outline-none shadow-xl" value="{{auth()->user()->userProfile->birthday}}">
             </div>
            ...
            <div class="p-4 flex items-center gap-4">
             ...
             <div class="p-4 flex items-center gap-4 max-w-[500px] mx-auto md:col-span-2">
                 <a href="{{route('admin.editProfile')}}"  class="text-white text-md max-sm:text-sm text-center rounded-md px-6 py-3 bg-green-500 hover:bg-green-600">EDIT PROFILE</a>
                 <a href="{{route('admin.updatePassword')}}" class="text-white text-md max-sm:text-sm text-center rounded-md px-6 py-3 bg-gray-500 hover:bg-gray-600">UPDATE PASSWORD</a>
             </div>
            @endif
         </div> 
