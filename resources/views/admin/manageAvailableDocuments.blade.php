...
@section('content')
    ...
    <section class="xl:max-w-[1300px] 2xl:max-w-[1500px] mx-auto p-4 w-full px-16 max-lg:px-4">
        <div class="py-4 flex justify-between items-center max-md:flex-col max-md:justify-center max-md:gap-6">
            <h4 class="font-bold text-2xl text-center max-sm:text-xl">Manage Documents</h4>
           <div class="flex gap-3">
            <a href="{{route('admin.createDocument')}}" class="pt-2 px-6 max-sm:py-2 max-sm:px-4 bg-purple-600 rounded-md outline-none border-none text-white hover:bg-purple-700 ">Create Document</a>
            ...
            document.querySelectorAll('[data-toggle-modal]').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    if (fileId) {
                        ...
                        const deleteUrl = `/admin/deleteDocument/${fileId}`;
