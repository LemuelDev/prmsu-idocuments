    ...
    <section class="xl:max-w-[1300px] 2xl:max-w-[1500px] mx-auto p-4 w-full px-8 max-lg:px-4">
            ...
            <form method="POST" action="{{route('admin.updateUsers', $user->id)}}" class="w-full grid md:grid-cols-2 grid-cols-1 gap-4" >
                ...
                <div class="p-4 flex items-center gap-4">
                    ...
                    <input type="text" name="name" readonly  class="py-3 px-6 w-full rounded-md  border-gray-400 border-2 outline-noneshadow-xl" value="{{$user->name}}">
                </div>
                
                <div class="p-4 flex items-center gap-4">
                    <label for="email" class="font-bold">EMAIL:</label>
                    <input type="text" name="email" readonly  class="py-3 px-6 w-full rounded-md  border-gray-400 border-2 outline-noneshadow-xl" value="{{$user->email}}">
                </div>
                
                <div class="p-4 flex items-center gap-4">
                    <label for="address" class="font-bold">ADDRESS:</label>
                    <input type="text" name="address" readonly  class="py-3 px-6 w-full rounded-md  border-gray-400 border-2 outline-noneshadow-xl" value="{{$user->address}}">
                </div>
                ...
                <div class="p-4 flex items-center gap-4">
                    ...
                    <select name="year" id="year" @readonly(true) class="py-3 rounded-md w-full px-6  border-gray-400 border-2 outline-noneshadow">
