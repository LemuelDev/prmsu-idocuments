...
@section('content')
    ...
    <section class="xl:max-w-[1300px] 2xl:max-w-[1500px] mx-auto p-4 w-full px-16 max-lg:px-4">
        ...
        <div class="py-4 flex justify-between items-center max-md:flex-col max-md:justify-center max-md:gap-6">
            <h4 class="font-bold text-2xl text-center max-sm:text-xl">List of Requested Documents</h4>
            <form method="GET" class="flex items-center justify-center gap-4">
                <input type="text" placeholder="Search Document" name="search" id="search" class="py-3 max-sm:py-2  px-6 bg-transparent shadow  rounded-lg w-full border border-gray-400 focus:border-none focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        @include('admin.tableRequestForms')
                ...
                document.querySelectorAll('[data-toggle-modal]').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (fileId) {
                            ...
                            const deleteUrl = `/admin/trackRequest/${fileId}`;
