          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      @php
                        $avatarPath = Chatify::getUserWithAvatar(Auth::user())->userProfile->avatar;
                        $avatarUrl = asset('http://127.0.0.1:8000/storage/users-avatar/' . $avatarPath);
                       @endphp
                      ...
                      <p class="app-modal-header">Dark Mode <span class="
                       {{ Auth::user()->userProfile->dark_mode > 0 ? 'fas' : 'far' }} fa-moon dark-mode-switch"
                       data-mode="{{ Auth::user()->userProfile->dark_mode > 0 ? 1 : 0 }}"></span></p>
