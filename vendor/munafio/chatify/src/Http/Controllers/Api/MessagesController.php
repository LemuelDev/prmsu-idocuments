...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        ->where('userprofiles.id','!=',Auth::user()->id)
        ->select('userprofiles.*',DB::raw('MAX(ch_messages.created_at) max_created_at'))
    ...
    public function getFavorites(Request $request)
    {
        ...
        foreach ($favorites as $favorite) {
            $favorite->user = UserProfile::where('id', $favorite->favorite_id)->first();
        }
        return Response::json([
    ...
    public function search(Request $request)
    {
        ...
        $records = UserProfile::where('id','!=',Auth::user()->id)
    ...
    public function setActiveStatus(Request $request)
    {
        ...
        $status = UserProfile::where('id', Auth::user()->id)->update(['active_status' => $activeStatus]);
        return Response::json([
            'status' => $status,
        ], 200);
    }
